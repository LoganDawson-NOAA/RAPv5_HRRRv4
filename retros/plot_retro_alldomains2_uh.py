...
elif str.lower(case[0:3]) == 'apr' or str.lower(case[0:3]) == 'may':
  ...
  if (fhr >= 0):
    ...
    for ax in axes:
      ...
      if par == 1:
        ...
        cs_2 = m.pcolormesh(x2,y2,uh25_2,cmap=cm,vmin=25,norm=norm,ax=ax)
        ...
        cs = m.pcolormesh(x2,y2,uh25_dif,cmap=cmdif,norm=normdif,ax=ax)
